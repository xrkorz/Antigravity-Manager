...
#   $Version = "4.1.33"  # Install specific version
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "4.1.33"; irm https://raw.githubusercontent.com/lbjlaq/Antigravity-Manager/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    # NSIS installer: Antigravity.Tools_4.1.33_x64-setup.exe
