...
#   $Version = "4.2.1"  # Install specific version
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "4.2.1"; irm https://raw.githubusercontent.com/lbjlaq/Antigravity-Manager/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    # NSIS installer: Antigravity.Tools_4.2.1_x64-setup.exe
